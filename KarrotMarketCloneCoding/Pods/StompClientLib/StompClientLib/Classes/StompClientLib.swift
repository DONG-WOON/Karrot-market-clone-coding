...
class stomp: StompClientLib {
    override func subscribeToDestination(destination: String, ackMode: StompAckMode) {
        super.subscribeToDestination(destination: destination, ackMode: ackMode)
    }
}
